    ...
    <div className="min-h-screen bg-slate-50 lg:grid lg:grid-cols-[16rem_minmax(0,1fr)] lg:h-screen lg:max-h-screen lg:overflow-hidden">
      ...
      >
        ...
        <div className="p-4 border-t border-slate-800 space-y-2">
          {canAccessDriverApp(user) && (
            <Link
              to="/driver"
              className="flex items-center gap-2 text-amber-400 hover:text-amber-300 text-sm px-3 py-2 rounded-lg hover:bg-slate-800 transition-colors font-semibold"
            >
              <Truck className="w-4 h-4" /> Open Driver App
            </Link>
          )}
          <a
